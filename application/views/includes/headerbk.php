            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="javascript:void(0);" aria-expanded="false">
                        ...
                        <span id="totalMessages" class="badge badge-danger navbar-badge">0</span>
                        <div id="messageList" class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
                                    ...
                                    success: function(data) {
                                        ...
                                        data.messages.forEach(function(message) {
                                            $('#messageList').append(
                                                ...
                                                message.sender_name + ': ' + message.message + '</a>');
                                            ...
                                            div class = "media" >
                                            <
                                            img src = "<?= base_url(); ?>assets/dist/img/avatar<?= ($potoB == 'GR-001') ? '5.png' : '3.png' ?>"
                                            alt = "User Avatar"
