                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            ...
                                            <div class="card-tools">
                                                <a data-toggle="modal" data-target="#input-new-messages"> <i class="fa fa-plus"></i></a>
                                            </div>
                                        </div>
                                        <div class="card-body">
    ...
    $(document).ready(function() {
        ...
        function columnMessages() {
            $.ajax({
                ...
                success: function(response) {
                    if (response === null) {
                        ...
                        $.each(response.ColumnMessages, function(index, row) {
                            if (lastMessageTimestamp === null || row.created_at > lastMessageTimestamp) {
                                ...
                                <div class="container mt-2">
                                    <a id="select_sender" data-sender="${row.sender_id}" class="col-md-12 btn btn-secondary" style="display: flex; align-items: center;">
                                        <div style="display: flex;">
                                            <div style="overflow-y: auto; max-height: 60px; flex: 1;" id="potoColumn">
                                                <img src="<?= base_url(); ?>assets/dist/img/avatar${potoBox}" class="mr-3 img-circle" alt="User Avatar" style="width: 50px; height: 50px;">
                                            </div>
                                            <div style="overflow-y: auto; max-height: 60px; max-width: 160px;" id="dataColumn" class="text-left">
                                                    <p class="text-nowrap" style="margin:0px; max-width:150px;">${row.sender_name}</p>
                ...
                `;
                        messagesContainer.html(noMessagesHtml);
                    }
                },
