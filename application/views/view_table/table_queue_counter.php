...
<div id="divAutoRefresh">

    <div class="card">
        <!-- /.card-header -->
        <div class="card-body">
            <table id="tblCounter" class="table table-bordered table-striped ">
                ...
                <tbody>
                    <?php
                    if (!empty($CounterRecords)) {
                        foreach ($CounterRecords as $record) {
                    ?>
                            <tr>
                                <td><strong><?php echo $record->counter_name ?></strong></td>
                                <td><strong><?php echo $record->vehicle_license_plat ?></strong></td>
                            </tr>
                    <?php
                        }
                    }
...
<script>
    $(document).ready(function() {
        ...
        setTimeout(function() {
            $("#divAutoRefresh").load("TableQueueCounter");
        }, 5000);
