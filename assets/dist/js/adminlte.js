...
;(function (global, factory) {
  ...
  $__default['default'](document).on('click', SELECTOR_DATA_REFRESH, function (
    event,
  ) {
    if (event) {
  ...
  $__default['default'](document).on('click', SELECTOR_DATA_COLLAPSE, function (
    event,
  ) {
    if (event) {
      event.preventDefault()
  ...
  $__default['default'](document).on('click', SELECTOR_DATA_REMOVE, function (
    event,
  ) {
    if (event) {
      event.preventDefault()
  ...
  $__default['default'](document).on('click', SELECTOR_DATA_MAXIMIZE, function (
    event,
  ) {
    if (event) {
      event.preventDefault()
  ...
  $__default['default'](document).on('click', SELECTOR_DATA_TOGGLE$4, function (
    event,
  ) {
    event.preventDefault()
  ...
  $__default['default'](document).on('click', SELECTOR_DATA_TOGGLE$3, function (
    event,
  ) {
    if (event) {
      event.preventDefault()
  ...
  var IFrame = /*#__PURE__*/ (function () {
    ...
    _proto._fixHeight = function _fixHeight(tabEmpty) {
      ...
      if ($__default['default']('body').hasClass(CLASS_NAME_FULLSCREEN_MODE)) {
        ...
        var _navbarHeight = $__default['default'](
          SELECTOR_TAB_NAV,
        ).outerHeight()
    ...
    IFrame._jQueryInterface = function _jQueryInterface(operation) {
      ...
      if (
        ...
        /createTab|openTabSidebar|switchTab|removeActiveTab/.test(operation)
      ) {
        var _data
  ...
  $__default['default'](document).on('click', SELECTOR_SEARCH_BUTTON, function (
    event,
  ) {
    event.preventDefault()
  ...
  $__default['default'](document).on('click', SELECTOR_TOGGLE_BUTTON, function (
    event,
  ) {
    event.preventDefault()
